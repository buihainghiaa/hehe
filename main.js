...
function Explosion(cannonball) {
  ...
  this.init = function () {
    for (var i = 0; i < 10; i++) {
      ...
      this.particles.push(new Particle(this.source.x, this.source.y, dx, dy, 10, colors[ 0 ].particleImage));
    }
  };
...
function animate() {
  ...
  canvas.style.backgroundImage = "url('bg.jpg')"; // Thay 'new_bg.jpg' bằng đường dẫn đến tệp hình ảnh mới
